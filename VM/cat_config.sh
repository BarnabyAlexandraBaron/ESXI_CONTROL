...
# ==============================================================================
# 例如：
# sudo ./configure_ovs_dpdk_sw.sh sw2 2 10.112.88.99 6633 sw2-sw1 ens36 sw2-h2 ens37
# sudo ./configure_ovs_dpdk_sw.sh sw1 1 10.112.88.99 6633 h1-sw1 ens36 sw1-sw2 ens37
# 1. 参数初始化和验证
BRIDGE_NAME="$1"
DPID_DEC="$2"
CONTROLLER_IP="$3"
